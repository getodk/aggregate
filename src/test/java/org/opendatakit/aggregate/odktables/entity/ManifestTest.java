...
public class ManifestTest {
  ...
  public void toJson() throws JsonGenerationException, JsonMappingException, IOException {
    ...
    assertEquals(
        "[{\"tableId\":\"this-is-a-uuid\",\"partition\":null,\"aspect\":\"brother_of_skyrim_weapons\",\"key\":\"list\",\"type\":\"file\",\"value\":\"{greetings, I am a json string (no i'm not) }\"},{\"tableId\":\"this-is-a-uuid-TIMES-ONE-FREAKING-THOUSAND\",\"partition\":\"foo\",\"aspect\":\"sister_of_skyrim_weapons\",\"key\":\"box\",\"type\":\"surprise\",\"value\":\"guess what's in the box...\"}]",
        manifest.getManifestForTesting());
  }

  /**
   * This will hopefully take things from a manifest and convert them to
   * objects. The manifest comes from a certain snapshot of the datastore.
   *
   * @throws IOException
  ...
  public void getObjectsFromManifest() throws JsonParseException, JsonMappingException, IOException {
    ...
    // String singleEntry =
    // "{\"tableId\":\"b6ca94aa-68e2-4e8f-adf8-94ced5780fe3\",\"tableName\":\"skyrim weapons\",\"key\":\"box\",\"type\":\"file\",\"value\":\"{\"\"testesttest\"\"}\"\"}";
    ...
    // OdkTablesKeyValueStoreEntry entry = mapper.readValue(singleEntry,
    // OdkTablesKeyValueStoreEntry.class);
    ...
    OdkTablesFileManifestEntry fileEntry = mapper.readValue(entries.get(0).value,
        OdkTablesFileManifestEntry.class);
