...
public class KmlServlet extends ServletUtilBase {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    String geopointFieldName = getParameter(req, "geopointField");
    String titleFieldName = getParameter(req, "titleField");
    String imageFieldName = getParameter(req, "imageField");
	...
	FormDataModel titleField = null;
	if ( titleFieldName != null ) {
		titleField = fdm.findElementByName(titleFieldName);
	}
	FormDataModel geopointField = null;
	if ( geopointFieldName != null ) {
		geopointField = fdm.findElementByName(geopointFieldName);
	}
	FormDataModel imageField = null;
	if ( imageFieldName != null ) {
		imageField = fdm.findElementByName(imageFieldName);
	}

	// and now try to get the form itself...
    try {
      ...
      SubmissionFormatter formatter = new KmlFormatter(query.getFormDefinition(), getServerURL(req), geopointField, titleField, imageField, resp.getWriter(), null, ds);     
