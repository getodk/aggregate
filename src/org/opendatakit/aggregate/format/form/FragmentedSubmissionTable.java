 ...
 * 
 */
public class FragmentedSubmissionTable {
	...
	private final int numEntriesToFetch;
	 ...
	 */
	public FragmentedSubmissionTable(Form form, String webServerURL, int numEntriesToFetch, 
			Query query, Datastore datastore, User user) throws ODKFormNotFoundException {
		this.webServerURL =  HtmlUtil.createUrl(webServerURL) ;
		this.form = form;
		this.query = query;
		this.numEntriesToFetch = numEntriesToFetch;
...
//		return HtmlUtil.createLinkWithProperties(webServerURL
...
//		properties.put(ServletConsts.FORM_ID, getKeySetReference(parentSubmissionSetKey, element.getKey()));
//		return HtmlUtil.createLinkWithProperties(webServerURL
...
//		Map<String, String> properties = new HashMap<String, String>();
//		properties.put(ServletConsts.FORM_ID, getKeySetReference(selfKey, formElementKey));
//		return HtmlUtil.createLinkWithProperties(webServerURL
//				+ FragmentedCsvServlet.ADDR, properties);
//	}
//
...
//		}
//
//		properties.put(ServletConsts.FORM_ID, getKeySetReference(parentKey, formElementKey));
//		return HtmlUtil.createLinkWithProperties(webServerURL
//				+ FragmentedCsvServlet.ADDR, properties);
//	}
//
...
//		}
//		
//		String nameSuffix = form.getFormId();
...
//	 */
//	public ResultTable generateResultTableFrag( List<SubmissionKeyPart> submissionPath,
...
//	 * @throws ODKFormNotFoundException
//	 */
//	public ResultTable generateRepeatResultTableFrag(List<SubmissionKeyPart> odkPath,
...
//		propertyNames.add(PARENT_KEY_PROPERTY);
//		headerTypes.put(PARENT_KEY_PROPERTY, SubmissionFieldType.STRING);
//
//		headers.add(RESULT_TABLE_KEY_STRING);
//		propertyNames.add(RESULT_TABLE_KEY_STRING);
//		headerTypes.put(RESULT_TABLE_KEY_STRING, SubmissionFieldType.STRING);
...
//			}
//			if ( parentKey == null ||
//				 parentKey.equals(element.getProperty(PARENT_KEY_PROPERTY)) ) {
...
//			if ( parentKey != null ) {
//				surveyQuery.addFilter(PARENT_KEY_PROPERTY, FilterOperator.EQUAL, parentKey);
//			}
//	
...
//			submissionData = new StringSubmissionType(PARENT_KEY_PROPERTY);
//			submissionData
//					.setValueFromString(createParentLink(sub.getParentSubmissionSetKey(),elementKey.getParent()));
//			valueMap.put(PARENT_KEY_PROPERTY, submissionData);
//			// and add the self-KEY to the map...
