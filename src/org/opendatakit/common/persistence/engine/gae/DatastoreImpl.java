...
public class DatastoreImpl implements Datastore {
	...
	private com.google.appengine.api.datastore.Entity prepareGaeFromRow(
			CommonFieldsBase entity, User user) {
		...
		if (entity.getOpaquePersistenceData() == null) {
			throw new IllegalStateException(
					"Entity should have opaque persistence data!");
		}
		else {
			e = (com.google.appengine.api.datastore.Entity) entity
					.getOpaquePersistenceData();
	...
	@Override
	public void putEntities(Collection<? extends CommonFieldsBase> entities,
