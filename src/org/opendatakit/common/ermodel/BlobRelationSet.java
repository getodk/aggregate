...
public interface BlobRelationSet {
	...
	/**
	 * Create a new blob entity set.  This blob entity set does not exist in
	 * the database until you put() it there or add a blob.
	 * 
	 * @param cc
	 * @return
	...
	/**
	 * Persist the blob entity set to the datastore.  Only useful if this is an empty blob set.
	 ...
	 * saving the list of blob entity sets.
	 * 
	 * @param e
	 * @param cc
	 * @throws ODKEntityPersistException
	...
	/**
	 * This is just a convenience method.  It may fail midway through 
	 * deleting the list of blob entity sets.
	 * 
	 * @param e
	 * @param cc
	 * @throws ODKDatastoreException 
	 */
	public void deleteBlobEntitySets( List<BlobEntitySet> e, CallingContext cc ) throws ODKDatastoreException;
	
	/**
	 * Delete all the blob entity sets and drop their underlying relations (tables).
	 * 
	 * @param cc
	 * @throws ODKDatastoreException
	 */
