 ...
 *
 */
public class JRTimeType extends DateSubmissionType {
   ...
   */
  public JRTimeType(String propertyName) {
    super(propertyName);
  }
  ...
  public void addValueToXmlSerialization(FormElement element, StringBuilder b) {
     ...
     if ( value != null ) {
        ...
        SimpleDateFormat fmt = new SimpleDateFormat(ParserConsts.PATTERN_ISO8601_TIME); // time zone included
