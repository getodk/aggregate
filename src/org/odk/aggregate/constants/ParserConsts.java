...
public class ParserConsts {
  ...
  public static final String PATTERN_ISO8601 = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";

  public static final String PATTERN_ISO8601_TIME = "HH:mm:ss.SSSZ";

  public static final String PATTERN_YYYY_MM_DD_DATE_ONLY_NO_TIME_DASH = "yyyy-MM-dd";
