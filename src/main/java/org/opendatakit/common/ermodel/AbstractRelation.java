...
public class AbstractRelation implements Relation {
   ...
   */
  protected AbstractRelation(String tableName, List<DataField> fields, CallingContext cc)
      throws ODKDatastoreException {
   ...
   * @throws ODKDatastoreException
   */
  protected AbstractRelation(String namespace, String tableName, List<DataField> fields,
   ...
   * @throws ODKDatastoreException
   */
  protected AbstractRelation(TableNamespace type, String tableName, List<DataField> fields,
      CallingContext cc) throws ODKDatastoreException {
   ...
   */
  @Override
  public List<Entity> getEntities(DataField dataField, Query.FilterOperation op, Object value,
      CallingContext cc) throws ODKDatastoreException {
  ...
  public class EntityImpl implements Entity {
    ...
    public void setInteger(DataField fieldName, Integer value) {
      backingObject.setLongField(verify(fieldName), (value == null) ? value : Long.valueOf(value));
    }
    ...
    public void setField(String fieldName, String value) {
      ...
      if (fieldName.matches(VALID_UPPER_CASE_NAME_REGEX)) {
        ...
        f = AbstractRelation.this.getDataField(WebUtils.unCamelCase(fieldName));
      }
