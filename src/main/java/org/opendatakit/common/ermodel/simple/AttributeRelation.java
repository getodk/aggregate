...
public final class AttributeRelation extends Relation {
  ...
  private static final Attribute relationName = new Attribute(RELATION_NAME, AttributeType.STRING,
      false);
  private static final Attribute attributeName = new Attribute(NAME, AttributeType.STRING, false);
  private static final Attribute attributeType = new Attribute(TYPE, AttributeType.STRING, false);
   ...
   */
  private AttributeRelation(String namespace, CallingContext cc) throws ODKDatastoreException {
