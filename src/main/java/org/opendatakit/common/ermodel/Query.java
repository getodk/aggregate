...
public class Query {
   ...
   *
   * @param field the field in the Relation.
   * @param value the value the given field should be equal to. This must be of the
   ...
   * Add an equal filter to the query.
   *
   * @param fieldName the name of an field in the Relation.
   * @param value     the value the given field should be equal to. This must be of the
   *                  correct type for the corresponding field.
   * @return this Query, with the equal filter added.
   */
   ...
   *
   * @param field the field in the Relation.
   * @param value the value the given field should be not equal to. This must be of
   ...
   *
   * @param field the field in the Relation.
   * @param value the value the given field should greater than. This must be of the
   *              correct type for the corresponding field.
   ...
   *
   * @param field the field in the Relation.
   * @param value the value the given field should greater than or equal to. This
   ...
   *
   * @param field the field in the Relation.
   * @param value the value the given field should less than. This must be of the
   *              correct type for the corresponding field.
   ...
   *
   * @param field the field in the Relation.
   * @param value the value the given field should less than or equal to. This must
   ...
   *
   * @param fieldName the name of an field in the Relation.
   * @param op        the operation to filter with.
   * @param value     the value to filter with. This must be of the correct type for the
   *                  corresponding field.
   ...
   *
   * @param field the field to sort by. This field must be an field in
   ...
   * Adds an ascending sort to the query.
   *
   * @param fieldName the name of the field to sort by. This field must be an field in
   *                  the Relation of this query.
   * @return this Query, with the ascending sort added.
   */
   ...
   *
   * @param field  the field to filter with. This must be an field in the
   *               Relation of this query.
   * @param values the values to filter by. This collection must be of the correct
   ...
   * given fieldName is in values.
   *
   * @param fieldName the name of the field to filter with. This must be an field in the
   *                  Relation of this query.
   * @param values    the values to filter by. This collection must be of the correct
   *                  type for the field identified by fieldName. Must not be null or
   *                  empty.
   ...
   * @throws ODKDatastoreException if the results contained more than one entity or if there is a
   ...
   * criteria.
   *
   * @param field the name of the field to retrieve distinct values for.
   ...
   * criteria.
   *
   * @param fieldName the name of the field to retrieve distinct values for.
   * @return a list of distinct values for the given field, narrowed by any
   *     existing filter and sort criteria.
   */
