...
public class ExtendedAbstractRelation extends AbstractRelation
{
     ...
     */
    public ExtendedAbstractRelation(String tableName, List<DataField> fields,
     ...
     */
    public ExtendedAbstractRelation(String namespace, String tableName,
     ...
     */
    public ExtendedAbstractRelation(TableNamespace type, String tableName,
            List<DataField> fields, CallingContext cc)
            throws ODKDatastoreException
    {
