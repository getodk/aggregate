...
public abstract class SubmissionFormatBase {
   ...
   *
   * @param xform            the form being formatted
   * @param webServerURL     url of aggregate instance, the base that appends to the servlet address
   * @param separateGeopoint true if gps coordinates should be separated, false otherwise
   */
