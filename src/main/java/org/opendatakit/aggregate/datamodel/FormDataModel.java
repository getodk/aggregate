...
public final class FormDataModel extends CommonFieldsBase {
	...
	/**
	 * Predicate function for determining whether a given field is one that
	 * is expected to be stored within a data table, vs. in a special auxiliary
	 * table.  Returns true if it is stored in a data table.
	 *
	 * This predicate function is used to determine if a parent FormDataModel
	 * is divided across multiple data tables.
	 *
	 * @param t
	 * @return
	 */
