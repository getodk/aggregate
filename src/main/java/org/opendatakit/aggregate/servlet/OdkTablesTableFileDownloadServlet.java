...
/**
 * The servlet that handles the downloading of table files. 
 * Based mostly on XFormsDownloadServlet.
...
public class OdkTablesTableFileDownloadServlet extends ServletUtilBase {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		// here I am diverging from XFormsDownloadServlet. They have a Submission Key.
		// I am planning on the key passed in being the key to the file in the datastore.
