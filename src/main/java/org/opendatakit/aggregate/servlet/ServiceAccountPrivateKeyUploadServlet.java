...
public class ServiceAccountPrivateKeyUploadServlet extends ServletUtilBase {
   ...
   */
  private static final String TITLE_INFO = "Google API Service Account Private Key Upload";
  ...
  "<div style=\"overflow: auto;\"><p id=\"subHeading\"><h2>Upload Google API Service Account information into ODK Aggregate</h2></p>"
      + "<p>Please refer to the documentation at <a href=\"http://opendatakit.org/use/aggregate/oauth2-service-account/\">Service Account Configuration</a>. "
      + "Google API Service accounts are required when publishing to Google Spreadsheets, Google FusionTables, and using Google Maps visualizations.</p>"
  ...
  private static final String UPLOAD_PAGE_BODY_MIDDLE = "\">"
      ...
      + "      </tr>"
      + "	  	<tr>"
      + "	  		<td><input type=\"submit\" name=\"button\" class=\"gwt-Button\" value=\"Upload Service Account Information\" /></td>"
      + "	  		<td />"
      + "	  	</tr>"
      + "	  </table>\n"
      + "	  </form>"
