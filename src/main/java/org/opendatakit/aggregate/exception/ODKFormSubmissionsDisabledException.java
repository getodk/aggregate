 ...
 * 
 */
public class ODKFormSubmissionsDisabledException extends Exception {
   ...
   * Default constructor
   */
  public ODKFormSubmissionsDisabledException() {
    super();
  }
   ...
   *    exception message
   */
  public ODKFormSubmissionsDisabledException(String message) {
    super(message);
  }
   ...
   *    throwable cause
   */
  public ODKFormSubmissionsDisabledException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *    throwable cause
   */
  public ODKFormSubmissionsDisabledException(Throwable cause) {
    super(cause);
  }
