...
public class TableServiceImpl implements TableService {
	...
	public List<TableResource> getTables() throws ODKDatastoreException {
		...
		final java.util.ArrayList<org.opendatakit.aggregate.odktables.api.entity.TableResource> resources = new ArrayList<TableResource>();
	...
	public TableResource getTable(String tableId) throws ODKDatastoreException {
		...
		final org.opendatakit.aggregate.odktables.api.entity.TableResource resource = getResource(entry);
		return resource;
	}
