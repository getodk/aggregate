...
public class EntityConverter {
  ...
  public List<TableEntry> toTableEntryEntities(List<Entity> entities) {
    final java.util.ArrayList<org.opendatakit.aggregate.odktables.entity.TableEntry> entries = new ArrayList<TableEntry>();
  ...
  public Row toRow(Entity entity, List<Entity> columns) {
    final org.opendatakit.aggregate.odktables.entity.Row row = new Row();
    ...
    final java.util.HashMap<java.lang.String, java.lang.String> values = new HashMap<String, String>();
  ...
  public List<Row> toRows(List<Entity> entities, List<Entity> columns) {
    final java.util.ArrayList<org.opendatakit.aggregate.odktables.entity.Row> rows = new ArrayList<Row>();
    for (Entity entity : entities) {
