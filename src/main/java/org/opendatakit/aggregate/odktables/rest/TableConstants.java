...
public class TableConstants {
  ...
  /**
   * (savepoint_timestamp, savepoint_type, form_id, locale) are the tuple
   ...
   * upon whether or not the table is 'form-managed' or not. If form-managed,
   * and direct cell editing is allowed, it should set 'savepoint_type' to
   * 'INCOMPLETE' and should leave form_id unchanged. Otherwise, it can set
   * 'savepoint_type' to 'COMPLETE' and set form_id to null.
   *
