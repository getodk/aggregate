...
//    }
  ...
  /*
  public boolean export(File file, String tableId, boolean includeTs, boolean includePn) {
    return export(file, tableId, includeTs, includePn, true);
  }

  public boolean exportWithProperties(File file, String tableId, boolean includeTs,
      boolean includePn) {
  ...
  private boolean export(File file, String tableId, boolean includeTs, boolean includePn,
    ...
    int columnCount = tp.getColumns().length + (includeTs ? 1 : 0) + (includePn ? 1 : 0);
