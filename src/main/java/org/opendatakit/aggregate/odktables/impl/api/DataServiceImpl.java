...
public class DataServiceImpl implements DataService {
	...
	public List<RowResource> getRows() throws ODKDatastoreException {
		...
		final java.util.ArrayList<org.opendatakit.aggregate.odktables.entity.api.RowResource> resources = new ArrayList<RowResource>();
	...
	public RowResource getRow(String rowId) throws ODKDatastoreException {
		...
		final org.opendatakit.aggregate.odktables.entity.api.RowResource resource = getResource(row);
		return resource;
	}
