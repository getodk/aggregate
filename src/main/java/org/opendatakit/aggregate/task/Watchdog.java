 ...
 */
public class Watchdog implements SmartLifecycle, InitializingBean,
    ServletContextAware {
  ...
  /**
   * object used to cancel the fixed-rate scheduled Watchdog task
   */
  private ScheduledFuture<?> watchdogFuture = null;
  /**
   * the scheduling interval of the fixed-rate scheduled Watchdog task
   */
