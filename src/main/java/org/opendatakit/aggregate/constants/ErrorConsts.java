...
public final class ErrorConsts {
   ...
   */
  public static final String ENKETOAPI_RETURN_NULL_RESPONSE = "Problem accessing Enketo. Please verify the preferences for Enketo Webform Integration and try again.";
