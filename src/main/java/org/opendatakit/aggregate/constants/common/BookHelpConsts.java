...
public enum BookHelpConsts {
	...
	XFORM("Forms", 
			...
			"&nbsp;This setting allows the form to accept data while it is in Aggregate.", 
			"How do I add a new form? (Press \"New Form\" on \"Form Management\" -> \"Forms List\")<br>" +
	...
	SUBMISSIONS("Submissions", 
			...
			"table.", 
			"How do I upload data? (Press \"Upload Data\" on \"Form Management\" -> \"Forms List\")<br>" +
			"&nbsp;1.  Form Definition - required.  Please choose the .xml file that will be used.<br>" +
	"&nbsp;2.  Media File(s) - optional.  Choose the appropriate media files for the form."),
	...
	FILTER("Filters", 
			...
			"filter:<br>" +
			"&nbsp;1.  Display columns location", 
			"How do I add a filter? (Press \"Add Filter\" on " +
	...
	METADATA("Metadata", 
			...
			"and id numbers", 
			"You can toggle whether or not you view metadata by clicking the \"Display Metadata\"" +
	...
	VISUALIZE("Visualize", 
			...
			"graph, pie chart, or on a map.",
			"How do I visualize the data? (Press \"Visualize\" on \"Submissions\" -> \"Filter Submissions\" " +
			...
			"&nbsp;&nbsp;b.  Select the column that you want to work with on the y axis, or choose " +
			"\"Number of Occurrences\" to simply to get a count of column entries in your x axis.<br>" +
			"&nbsp;&nbsp;c.  Press \"Pie It\".<br>" +
	...
	EXPORT("Export", 
			...
			"a CSV file (Excel) or a KML file (Google Maps).",
			"How do I export a file? (Press \"Export\" on \"Submissions\" -> \"Filter Submissions\" " +
			"or on \"Form Management\" -> \"Forms List\")<br>" +
	...
	private BookHelpConsts(String title, String concept, String procedures) {
		this.title = title;
