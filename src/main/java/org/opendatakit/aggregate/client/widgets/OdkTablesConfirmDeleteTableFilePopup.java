 ...
 */
public class OdkTablesConfirmDeleteTableFilePopup extends AbstractPopupBase {
  ...
  // the filePath you're deleting
  private final String filePath;

  @SuppressWarnings("unused")
  private AggregateSubTabBase basePanel;

  public OdkTablesConfirmDeleteTableFilePopup(AggregateSubTabBase basePanel, String odkClientApiVersion, String tableId, String filePath) {
    super();
  ...
  private class ExecuteDelete implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      ...
      SecureGWT.getServerDataService().deleteTableFile(odkClientApiVersion, tableId, filePath, callback);
      hide();
    }
  }
}
