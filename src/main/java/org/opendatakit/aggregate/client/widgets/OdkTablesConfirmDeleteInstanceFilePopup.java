 ...
 */
public class OdkTablesConfirmDeleteInstanceFilePopup extends AbstractPopupBase {
  ...
  private class ExecuteDelete implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      ...
      SecureGWT.getServerDataService().deleteInstanceFile(tableId, instanceId, filePath, callback);
      hide();
    }
  }
}
