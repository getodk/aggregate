...
public abstract class AbstractCheckBoxBase extends CheckBox implements ValueChangeHandler<Boolean>, MouseOverHandler, MouseOutHandler {
  
  private String tooltipText;
  protected HelpBalloon helpBalloon;
  
  public AbstractCheckBoxBase(String tooltipText) {
    super();
    constructorHelper(tooltipText);
  }
  
  public AbstractCheckBoxBase(String label, String tooltipText) {
    super(label);
    constructorHelper(tooltipText);
  }
  
  private void constructorHelper(String tooltipText) {
