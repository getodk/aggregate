...
/**
 * Background refresh timer that polls the server every 5 seconds
 * for changes to whichever tab is currently selected.  If no
 * UI interaction has happened for 5 minutes, the refreshes stop. 
 * 
