...
/**
 * Equivalent to the AccessConfigurationServlet functionality, without the
 * custom-configuration treatment detection.
 * 
 * @author mitchellsundt@gmail.com
 *
 */
public class AccessConfigurationSheet extends Composite implements ActionCell.Delegate<UserSecurityInfo> {
	...
	private static AccessConfigurationSheetUiBinder uiBinder = GWT
			.create(AccessConfigurationSheetUiBinder.class);

	interface AccessConfigurationSheetUiBinder extends
	...
	public AccessConfigurationSheet() {
