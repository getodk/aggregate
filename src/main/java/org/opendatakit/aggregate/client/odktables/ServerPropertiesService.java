...
/**
 * This will be the PropertiesService for the server. It will act the same way
 * as org.opendatakit.aggregate.odktables.api.PropertiesService, except that it
 * will be for interacting with the table information on the server, rather than
 * with a phone.
 *
 * @author sudar.sam
 */
